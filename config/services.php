...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configurations for OAuth 2.0 social authentication providers
    | using Laravel Socialite and SocialiteProviders.
    |
    */
    ...
    'x-twitter' => [
        ...
        'redirect' => env('X_REDIRECT_URI', env('APP_URL').'/auth/x-twitter/callback'),
    ],
